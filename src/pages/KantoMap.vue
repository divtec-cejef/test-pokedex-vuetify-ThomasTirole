...
<template>
  <v-container max-width="600px">
    ...
    <v-img alt="La carte du monde Pokémon" class="cursor-pointer" src="/images/pokemon-map.png" @click="dialog=true" />
    <v-card class="my-8">
      <v-card-text>
    ...
    <v-dialog v-model="dialog">
      <v-card>
        <v-img alt="La carte du monde Pokémon en grand" src="/images/pokemon-map.png" />
        <v-card-actions>
